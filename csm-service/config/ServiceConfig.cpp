...
ServiceConfig::ServiceConfig(tool::NodeConfig::Ptr nodeConfig, utilities::SelectListenner::Ptr listenner, Acceptor::Ptr acceptor,
                             ...
                             HostsHeartbeatService::Ptr hostsHeartbeatService, DistanceVector::Ptr distanceVector)
    : m_nodeConfig(std::move(nodeConfig)), m_listenner(std::move(listenner)), m_acceptor(std::move(acceptor)),
      ...
      m_sessionServiceDataProcessor(std::move(sessionServiceDataProcessor)),
      m_sessionModuleDataProcessor(std::move(sessionModuleDataProcessor)), m_serviceStartType(serverStartType),
      m_hostsInfoManager(std::move(hostsInfoManager)), m_hostsConnector(std::move(hostsConnector)),
      m_hostsHeartbeatService(std::move(hostsHeartbeatService)), m_distanceVector(std::move(distanceVector))
{
}
